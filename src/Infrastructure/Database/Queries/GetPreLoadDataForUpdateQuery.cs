...
{
    public class GetPreLoadDataForUpdateQuery : IGetPreLoadDataForUpdateQuery
    {
        private readonly IDbContextFactory _dbContextFactory;

        public GetPreLoadDataForUpdateQuery(IDbContextFactory dbContextFactory)
        {
        ...
        public List<PreLoadStudentSection> ExecuteQuery(QueryInputParams queryInputParams)
        {
            ...
            return context.PreLoadStudentSections
                .Where(r => r.StartDate >= queryInputParams.CutOffStartDateTime)
