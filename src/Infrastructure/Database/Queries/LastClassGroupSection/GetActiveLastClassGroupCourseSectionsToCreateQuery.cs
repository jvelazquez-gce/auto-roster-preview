...
{
    public class GetActiveLastClassGroupCourseSectionsToCreateQuery : IGetActiveLastClassGroupCourseSectionsToCreateQuery
    {
        private readonly IDbContextFactory _dbContextFactory;

        public GetActiveLastClassGroupCourseSectionsToCreateQuery(IDbContextFactory dbContextFactory)
        {
        ...
        public List<CourseSection> ExecuteQuery(QueryInputParams parameters)
        {
            ...
            return context.CourseSections
                ...
                .Where(r => r.GroupCategory == ARBGroupCategory.LAST_CLASS_TOGETHER_COHORT)
