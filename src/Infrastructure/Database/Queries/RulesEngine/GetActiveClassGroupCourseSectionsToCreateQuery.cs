...
{
    public class GetActiveClassGroupCourseSectionsToCreateQuery : IGetActiveClassGroupCourseSectionsToCreateQuery
    {
        private readonly IDbContextFactory _dbContextFactory;

        public GetActiveClassGroupCourseSectionsToCreateQuery(IDbContextFactory dbContextFactory)
        {
        ...
        public List<CourseSection> ExecuteQuery(QueryInputParams parameters)
        {
            ...
            return context.CourseSections
                ...
                .Where(r => r.GroupCategory == ARBGroupCategory.RULES_CLASS_TOGETHER_COHORT)
