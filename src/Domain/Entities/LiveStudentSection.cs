...
{
    [Table("LiveStudentSections")]
    public class LiveStudentSection
    {
        public LiveStudentSection()
        {
            Campus = GeneralStatus.CAMPUS_ONLINE;
            GroupCategory = ARBGroupCategory.GENERAL;
            OldSectionId = null;
            NewSectionId = null;
        }
